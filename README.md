...
* **Read the full technical white paper on hook placement and telemetry extraction here:** [Architecture Overview & Pipeline Mechanics](docs/ARCHITECTURE_OVERVIEW.md)
---
...
### 2. Run Hardware_Synchronized MPS Streaming Benchmark
